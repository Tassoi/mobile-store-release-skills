...
tests/golden/ Expected findings for each release-risk fixture.
...
`tests/golden/` contains expected minimum findings for each release-risk fixture. These files are not generated by an agent; they document the behavior the skills should preserve as fixtures and references evolve.
